...
| unhcr_population_api | UNHCR Refugee Statistics API | https://api.unhcr.org/population/v1/population/ | 1975–2024 | **Ingested** → `unhcr_refugee_stock_by_coa.jsonl` (COA stock; no COO in dump). |
